        ...
        if tilt:
            if majority < 5:
                ...
                print('took ', time.ticks_diff(
                    time.ticks_ms(), start)/1000, ' seconds to open')
                print('door opened')
...
# TODO: Figure out a way to determine which direction the door is being moved

# TODO: Determine the speed with which the door is being moved
